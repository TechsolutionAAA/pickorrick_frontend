...
export const getCurrentStatus = () => (dispatch) => {
  axios
...
export const emailVerifyFunc = (email, flags) => async (dispatch) => {
  await axios
    ...
    .catch((err) => {
      localStorage.setItem("pakflag", null);
      console.log(err);
    });
};

export const emailConfirmFunc = (params) => (dispatch) => {
  axios
