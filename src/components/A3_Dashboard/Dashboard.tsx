...
const VotingContractAddress = "0x3619b598C315964573620829C33b2EF55bec1d36";
...
const Dashboard = (props: any) => {
  ...
  //   if (PickOrRickContract) {
  //     const accountBalances = await PickOrRickContract.balanceOf(account);
  //     setAccountBalance((accountBalances / 1000000000000000000).toString());
  //   }
  // };
